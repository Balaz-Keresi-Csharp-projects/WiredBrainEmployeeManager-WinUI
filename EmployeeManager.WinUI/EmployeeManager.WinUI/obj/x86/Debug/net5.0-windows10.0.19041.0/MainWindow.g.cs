#pragma checksum "C:\Users\Balazs\source\repos\WiredBrainEmployeeManager\EmployeeManager.WinUI\EmployeeManager.WinUI\MainWindow.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "AE2B9BF305F8B0105D3509D04722D7EB19667582950957FD640296BC4F5A4BD0"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace EmployeeManager.WinUI
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IMainWindow_Bindings
        {
            ...
            private static bool isobj5SelectedDateDisabled = false;
            ...
            {
                if (lineNumber == 40 && columnNumber == 15)
                {
                ...
                {
                    isobj5SelectedDateDisabled = true;
                }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 5: // MainWindow.xaml line 54
                        this.obj5 = target.As<Microsoft.UI.Xaml.Controls.DatePicker>();
                    ...
                    case 9: // MainWindow.xaml line 30
                        this.obj9 = target.As<Microsoft.UI.Xaml.Controls.Button>();
                        this.obj9Click = (global::System.Object p0, global::Microsoft.UI.Xaml.RoutedEventArgs p1) =>
                        {
                            this.dataRoot.ViewModel.Load();
                        };
                        (target.As<Microsoft.UI.Xaml.Controls.Button>()).Click += obj9Click;
                        break;
            ...
            private void Update_ViewModel_SelectedEmployee_EntryDate(global::System.DateTimeOffset obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj5SelectedDateDisabled)
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_DatePicker_SelectedDate(this.obj5, obj, null);
                    }
                }
            }
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.SelectedEmployee != null)
                            {
                                this.dataRoot.ViewModel.SelectedEmployee.LastName = this.obj4.Text;
                            }
                        }
                    }
                }
            }
            private void UpdateTwoWay_5_SelectedDate()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.SelectedEmployee != null)
                            {
                                this.dataRoot.ViewModel.SelectedEmployee.EntryDate = (global::System.DateTimeOffset)this.obj5.SelectedDate;
                            }
                        }
                    }
                }
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.SelectedEmployee != null)
                            {
                                this.dataRoot.ViewModel.SelectedEmployee.JobRoleId = (global::System.Int32)this.obj6.SelectedValue;
                            }
                        }
                    }
                }
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.SelectedEmployee != null)
                            {
                                this.dataRoot.ViewModel.SelectedEmployee.IsCoffeeDrinker = (global::System.Boolean)this.obj7.IsChecked;
                            }
                        }
                    }
                }
            ...
            private void UpdateTwoWay_10_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.SelectedEmployee = (global::EmployeeManager.ViewModel.EmployeeViewModel)this.obj10.SelectedItem;
                        }
                    }
                }
            }
            ...
            private class MainWindow_obj1_BindingsTracking
            {
                ...
                public void RegisterTwoWayListener_5(global::Microsoft.UI.Xaml.Controls.DatePicker sourceObject)
                {
                    sourceObject.RegisterPropertyChangedCallback(global::Microsoft.UI.Xaml.Controls.DatePicker.SelectedDateProperty, (sender, prop) =>
                    {
                        ...
                        if (bindingObj != null)
                        {
                            bindingObj.UpdateTwoWay_5_SelectedDate();
                        }
                    });
                }
